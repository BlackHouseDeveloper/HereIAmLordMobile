...
using HereIAmLordMobile.Models.Onboarding;
using HereIAmLordMobile.Views.Onboarding;
using Syncfusion.SfRotator.XForms;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace HereIAmLordMobile.ViewModels.Onboarding
{
    /// <summary>
        ...
        public OnBoardingAnimationViewModel()
        {
            ...
            this.Boardings = new ObservableCollection<Boarding>
            {
                new Boarding()
                {
                    ...
                    Header = "RESCHEDULE",
                    Content = "Drag and drop the meetings in order to reschedule it easily.",
